 ...
 *  - secondaryPhone, birthDate, nationality, address
 *  - medicalConditions, currentMedications, allergies, notes
 */
public record CreatePatientRequest(
    ...
    @Pattern(regexp = "^[MF]$", message = "Género debe ser M (Masculino) o F (Femenino)")
    String gender,
